...
public:
    ...
    void draw(const std::deque<std::shared_ptr<const SolarObject>> & object, double JD, const std::string & group_id, object_rendering_type type = magnitudo, bool label = false);
